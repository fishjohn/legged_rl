...
#include "legged_rl_controllers/AmpController.h"
#include <pluginlib/class_list_macros.hpp>

namespace legged {

void AmpController::handleWalkMode() {
...
PLUGINLIB_EXPORT_CLASS(legged::AmpController, controller_interface::ControllerBase)
